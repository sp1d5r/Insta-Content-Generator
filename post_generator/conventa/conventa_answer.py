...
from post_generator.text_functions import add_logo, add_image_ontop, add_text_center, add_text_boxes, drawMappedValues
import random
...
class ConventaMatchOptionsAnswer():
    def __init__(self, background, mapping):
        ...
        flip_select_post = drawMappedValues(flip_select_post, keys, values, question_font, box_color=(227, 255, 234))
